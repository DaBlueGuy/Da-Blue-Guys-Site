function Slide1(){
    ...
    document.getElementById("t4").textContent = "Matieres:";
...
function Slide3(){
    ...
    document.getElementById("t3").textContent = "Mes Accessoires";
    document.getElementById("t4").textContent = "Tarification";
    document.getElementById("c1").textContent = "Mon ami vient chez moi pour regarder Harry Potter avec moi.";
    document.getElementById("c2").textContent = "J'ai mon t-shirt, mon sweat-shirt et mon pantalon de survetement.";
    document.getElementById("c3").textContent = "J'ai mes lunettes, ma bouteille d'eau et mon porte-monnaie pour acheter des snacks.";
    document.getElementById("c4").textContent = "Les snacks coutent environ 15 dollars, et le film Netflix, environ 10 dollars.";
}
